...
<!-- Jangan Edit Bagian Ini --><script>
  ...
  function finalakhir(){bodyblur.style="opacity:.5;animation:none";beneranblur.style="-webkit-backdrop-filter:blur(2px); backdrop-filter:blur(2px)";wallpaper.style="transform: scale(1)";bklik.innerHTML = "Hantar";ftom=2;otomatis();kalimatd.innerHTML = "Jawapan: " + pesanwhatsapp;} function sjawab(){if(ftom==1){jawab();} if(ftom==2){menuju();}}
...
<script type="text/javascript">
       async function menuju(){await swals.fire('hantar kt whatsapp');window.location = "https://api.whatsapp.com/send?phone=&text=" + pesanwhatsapp;}
       async function jawab(){
           var { value: jawaban } = await swals.fire({
               title: 'Tulis la ap2 oceyy &#128073;&#128072;', 
           ...
           if(jawaban && jawaban.length < 21){
               ...
               await swals.fire('lah', 'Tulis la ap2 ke tu pon susah 20 patah je, ya!');jawab();
           }
       }
       function linkaud(){
